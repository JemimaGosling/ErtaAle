...
SAR backscatter lava flow processing, analysis and detection for the 2017 Erta 'Ale lava flows. The method development and analysis are detailed fully in Gosling et al., (Submitted). This github contains:  
